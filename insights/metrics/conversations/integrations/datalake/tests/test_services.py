...
class DatalakeConversationsMetricsServiceTestCase(TestCase):
    ...
    def test_get_sales_funnel_data_exceeding_max_pages(
        self, mock_data_lake_events_count_client, mock_data_lake_events_client
    ):
        def get_events(**kwargs):
            if kwargs.get("offset") == 0:
    ...
    def test_get_sales_funnel_data_with_cached_data(
        self,
        mock_cache_get,
        mock_data_lake_events_count_client,
        mock_data_lake_events_client,
    ):
        mock_data_lake_events_count_client.return_value = [{"count": 10}]
        mock_data_lake_events_client.return_value = []
        ...
        mock_data_lake_events_client.assert_not_called()
        mock_data_lake_events_count_client.assert_not_called()
