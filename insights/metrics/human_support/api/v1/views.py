...
class DetailedMonitoringAgentsTotalsView(APIView):
    permission_classes = [IsAuthenticated, ProjectAuthQueryParamPermission]
    feature_flag_key = "human-support-detailed-monitoring"
    ...
    def get(self, request, *args, **kwargs):
        ...
        filters = get_filters_from_query_params(request.query_params)
        filters["user_request"] = request.user.email
        data = service.get_detailed_monitoring_agents_totals(filters=filters)
...
class AverageOrderValueView(APIView):
    permission_classes = [IsAuthenticated, ProjectAuthQueryParamPermission]
    feature_flag_key = "human-support-assisted-sales"
...
class ChannelRevenueSaleView(APIView):
    permission_classes = [IsAuthenticated, ProjectAuthQueryParamPermission]
    feature_flag_key = "human-support-assisted-sales"
...
class PerformanceByRepresentativeView(APIView):
    permission_classes = [IsAuthenticated, ProjectAuthQueryParamPermission]
    feature_flag_key = "human-support-assisted-sales"
