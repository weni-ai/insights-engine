...
DATALAKE_EVENTS_PAGE_SIZE = env.int("DATALAKE_EVENTS_PAGE_SIZE", default=1000)
DATALAKE_EVENTS_MAX_PAGES = env.int("DATALAKE_EVENTS_MAX_PAGES", default=100)
...
CONVERSATIONS_REPORT_PAGE_LIMIT = env.int(
    "CONVERSATIONS_REPORT_PAGE_LIMIT", default=100
)
CONVERSATIONS_REPORT_ELASTIC_PAGE_SIZE = env.int(
    "CONVERSATIONS_REPORT_ELASTIC_PAGE_SIZE", default=1000
)
...
CONVERSATIONS_METRICS_CONCIERGE_AGENT_SLUGS = env.list(
    "CONVERSATIONS_METRICS_CONCIERGE_AGENT_SLUGS", default=[]
)
CONVERSATIONS_METRICS_PAYMENT_AGENT_SLUGS = env.list(
    "CONVERSATIONS_METRICS_PAYMENT_AGENT_SLUGS", default=[]
)
...
ENABLE_CTWA_DASHBOARD_AUTO_CREATION = env.bool(
    "ENABLE_CTWA_DASHBOARD_AUTO_CREATION", default=False
)
...
INSIGHTS_SHOW_HUMAN_SUPPORT_DASHBOARD_V1_FEATURE_FLAG_KEY = env.str(
    "INSIGHTS_SHOW_HUMAN_SUPPORT_DASHBOARD_V1_FEATURE_FLAG_KEY",
    default="insightsShowHumanSupportDashboardV1",
)
...
NEXUS_CONVERSATIONS_TOPICS_MAX_PAGES = env.int(
    "NEXUS_CONVERSATIONS_TOPICS_MAX_PAGES", default=2
)
