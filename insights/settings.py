...
CONVERSATIONS_REPORT_DETAILED_EVENTS_FEATURE_FLAG_KEY = env.str(
    "CONVERSATIONS_REPORT_DETAILED_EVENTS_FEATURE_FLAG_KEY",
    default="insightsConversationsReportDetailedEvents",
)
