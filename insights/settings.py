...
SALES_FUNNEL_USE_PARALLEL_PROCESSING_FEATURE_FLAG_KEY = env.str(
    "SALES_FUNNEL_USE_PARALLEL_PROCESSING_FEATURE_FLAG_KEY",
    default="insightsSalesFunnelUseParallelProcessing",
)
