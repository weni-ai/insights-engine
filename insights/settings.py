...
# Sales Funnel
SALES_FUNNEL_EVENTS_MAX_PAGES = env.int("SALES_FUNNEL_EVENTS_MAX_PAGES", default=100)
SALES_FUNNEL_EVENTS_PAGE_SIZE = env.int("SALES_FUNNEL_EVENTS_PAGE_SIZE", default=5000)
