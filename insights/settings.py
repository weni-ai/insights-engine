...
REPORT_HEARTBEAT_TIMEOUT = env.int(
    "REPORT_HEARTBEAT_TIMEOUT", default=5 * 60
)  # 5 minutes
...
CONVERSATIONS_REPORT_CACHE_MAX_EVENTS = env.int(
    "CONVERSATIONS_REPORT_CACHE_MAX_EVENTS", default=50000
)
